import footimg from "../assets/Img/abbe28cc-09d1-45c7-9884-4f740267fbf5.jpg"
...
export default function Footer() {
    return (
        <div className="w-full  bg-[#333333] flex justify-center items-center">
            <div className="container  flex justify-center items-center">
                <div className="w-[500px] lg:w-full flex flex-col justify-between  px-30 pt-10 lg:pt-5">
                    {/* ---------------------------------------------------------------------- */}
                    {/* UpperDiv */}
                    <div className=" flex flex-col lg:flex-row lg:justify-between lg:items-center gap-5 lg:gap-20 pb-5 lg:pb-20 ">
                        ...
                        <div className="relative pl-13 lg:pl-0">
                            ...
                            <p className=" absolute bottom-3 left-33 -translate-x-1/2 lg:absolute lg:bottom-4 lg:left-1/2 lg:-translate-x-1/2 lg:pb-5 text-2xl  lg:text-5xl font-extrabold bg-linear-to-l from-[#d4af37] to-[#f5e39c] bg-clip-text text-transparent">Hayla</p>
                    ...
                    <div className="  flex flex-col lg:flex-row lg:justify-between gap-10 lg:gap-0 w-[500px] lg:w-full pt-10 lg:pt-20 pb-10 lg:pb-30 px-10 lg:px-50 ">
                        <div className="">
                            <a href="gmail.com">sarahasaad57@gmail.com</a>
                        </div>
                        <div className=" relative flex gap-3 pr-40">
                            <BsFillTelephoneFill />
                            <p className=" absolute  left-6  lg:bottom-6.5 lg:left-7"> 01285551980</p>
                        </div>

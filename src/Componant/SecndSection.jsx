...
export default function SecndSection() {
    return (
        <div className=" w-full h-[130dvh] lg:h-dvh  bg-gradient-to-b from-[#747837] to-[#43720c]">
            <div className="  lg:flex justify-center items-center  lg:gap-70 p-10 ">
                <div className=" pb-3 lg:w-full">
                    ...
                    <p className=" "> A Passion for Perfume, a Commitment to Quality
                        At ​Note & Soul, we believe that fragrance is more than just a scent — it's an experience, a memory, a feeling. Founded in 2024, our mission is to bring the finest, most captivating fragrances from around the world to your doorstep.
